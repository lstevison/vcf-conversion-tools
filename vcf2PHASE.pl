...
#program converts vcf file to PHASE input format
...
unless ($#ARGV==2) {
    print STDERR "Please provide name of input vcf file, filename for PHASE formatted output, and sample size on command line\n\n";
    die;
} #end unless
